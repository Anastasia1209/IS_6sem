...
internal class Steganography
{
    ...
    const string fileNameContainer = @"F:\BGTU\Course3\Sem2\Secur\Lab15\Container.txt";
    const string fileNameContainerHidden = @"F:\BGTU\Course3\Sem2\Secur\Lab15\Container_Hidden.txt";
    const string fileNameOpenText = @"F:\BGTU\Course3\Sem2\Secur\Lab15\Open_Text.txt";
